...
void CommandJS()
{
	...
	Serial.print(CutString(WebData, F("command="), 1));
	Serial.print(" ");
	Serial.print(CutString(WebData, F("value1="), 1));
	Serial.print(" ");
	Serial.print(CutString(WebData, F("value2="), 1));
	Serial.print(" ");
	Serial.println(CutString(WebData, F("value3="), 1));
